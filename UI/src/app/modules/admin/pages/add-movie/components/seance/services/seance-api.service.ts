    ...
    return [
      {
        ...
        start: new Date('April 30, 2019 8:05:00'),
        end: new Date('April 30, 2019 10:05:00')
      },
      {
        title: 'The Avengers',
        projectionType: ProjectionType.type2D,
        start: new Date('April 30, 2019 10:30:00'),
        end: new Date('April 30, 2019 12:05:00')
      },
      {
        title: 'Wróg u bram',
        projectionType: ProjectionType.type2D,
        start: new Date('April 30, 2019 13:05:00'),
        end: new Date('April 30, 2019 15:35:00')
      },
      {
        title: 'Linia Jordana',
        projectionType: ProjectionType.type2D,
        start: new Date('April 30, 2019 20:05:00'),
        end: new Date('April 30, 2019 22:35:00')
      },
    ];
  }
}
